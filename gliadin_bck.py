...
class HardSphericalWall:
    ...
    def PrintDetails(self):
        print
        "Hard Spherical Wall Boundary"
        print
        "Spherical Boundary Radius: ", self.radius, " center: ", self.center
        print
...
class HardCubicBox:
    ...
    def PrintDetails(self):
        print
        "Hard Cubic Box Boundary"
        print
        "Cubic Box Size: ", self.bx, " center: ", self.center
        print
        "Volume: ", self.ComputeVolume()
        return
...
" "
print
"Hello! I will run a Monte Carlo Simulation of a homogenous LJ system!"
print
" "
print
"Parameters have been set to: "
print
"Number of atoms: ", N, " epsilon: ", epsilon, " sigma: ", sigma, " mass: ", mass
print
"The Temperature: ", Temp, " Number of Trial Moves: ", MCit, "Number of Equilibration Steps: ", Eqit
print
"The interval to collect data after equilibration: ", Dit, " trial move step size: ", step
print
"The Pressure: ", Press
# print "Spherical Boundary Radius: ", radius, " center: ", center
boundary.PrintDetails()
print
"reduced temperature equivalent: ", rt
print
" "
...
# Energy = TotalPairEnergy(c)
print
"Energy of initial configuration: ", Energy
# Compute volume
Volume = boundary.ComputeVolume()
print
"Volume of initial configuration: ", Volume
# Enthalpy
H = Energy + Press * Volume
print
"Enthalpy of initial configuration: ", H
print
" "
...
print
"Beginning the sampling loop. Beta is: ", Beta, ". Please wait while I work..."
print
" "
factor = 1.0
...
for i in xrange(0, MCit):
    ...
    if i % Scit == 0:
        print
        "## Iteration ", i, " current averages: "
        if i < Eqit:
            print
            "Equilibrating..."
        else:
            print
            "Energy: ", Estat.Mean(), "Enthalpy: ", Hstat.Mean(), " Heat Capacity: ", Cpstat.Mean(), " Enthalpy Squared: ", Hsqstat.Mean()
            print
            "Radius of Gyration: ", Rgstat.Mean(), " Volume ", Vstat.Mean()
        print
        " "
...
"Simulation Complete!"
print
"Trial Move Acceptance ratios: "
print
"- Coordinate Deform: ", xar
print
"- Volume Deform: ", var
print
"Here are some final average values-"
print
"Energy: ", Estat.Mean()
print
"Enthalpy ", Hstat.Mean()
print
"Enthalpy Squared: ", Hsqstat.Mean()
print
"Heat Capacity: ", Cpstat.Mean()
print
"Radius of Gyration: ", Rgstat.Mean()
print
"Volume: ", Vstat.Mean()
print
"Final Instantaneous Heat Capacity: ", ccv
print
" "
print
